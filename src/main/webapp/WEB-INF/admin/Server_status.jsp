...
<div class="alert alert-success"><span class="label label-danger">管理员用户名</span><b>：${sessionScope.username}</b><br></div>
<div class="alert alert-success"><span class="label label-danger">系统总会员数</span><b>：<span id="num"></span>人</b><br></div>
...
<script type="text/javascript">
	...
	function GetCounts(){
		$.ajax({
			type:'post',
			url:'${pageContext.request.contextPath}/admin/adminsystemcounts.do',
			data:{},
